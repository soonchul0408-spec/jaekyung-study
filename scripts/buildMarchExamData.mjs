...
const questionsText = readFileSync('/private/tmp/jaekyung-2025-03-questions.txt', 'utf8')
const answersText = readFileSync('/private/tmp/jaekyung-2025-03-answers.txt', 'utf8')
...
writeFileSync('src/data/questions-2025-03.js', `// 2025년 3월 공식 기출문제 및 확정답안에서 개인 학습용으로 추출한 데이터입니다.\nexport const questions = ${JSON.stringify(questions, null, 2)}\n`)
console.log(`Generated ${questions.length} March questions.`)
