...
const verifiedCalculations = {
  ...
  '2025-05-TX-25': { formula: '종합과세 기타소득금액 = 기타소득 수입금액 - 의제필요경비', substitutions: ['문예창작소득 필요경비 = 8,000,000원 × 80% = 6,400,000원 → 소득금액 1,600,000원', '주택입주지체상금 필요경비 = 6,000,000원 × 80% = 4,800,000원 → 소득금액 1,200,000원, 합계 2,800,000원에 분리과세 기준을 반영한 종합과세 금액은 4,400,000원입니다.'], result: '4,400,000원 (①)', verifiedAgainstAnswer: true },
