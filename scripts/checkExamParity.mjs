...
for (const exam of examSets.filter((exam) => !exam.baseline)) {
  ...
  if (exam.questions.filter(hasVerifiedCalculation).length < januaryQuestions.filter(hasVerifiedCalculation).length) errors.push(`${exam.label} 검증 계산 과정이 1월 기준보다 적음`)
